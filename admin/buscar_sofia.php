...
if(isset($_POST['zona'])){
	...
	$result = $con->query("SELECT fila FROM sofia where seccion = '".$zona."' group by fila COLLATE utf8_spanish_ci");
...
if(isset($_POST['fila'])){
	...
	$result = $con->query("SELECT asiento FROM sofia where fila = '".$fila."' and status = 0");
